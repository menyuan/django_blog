# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-12-23 05:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='avatar/default.png', max_length=255, upload_to='avatar/%Y/%m')),
        ...
        migrations.AddField(
            model_name='comment',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.User', verbose_name='\u7528\u6237'),
        ),
        migrations.AddField(
            model_name='article',
            name='Category',
